...
def get_region_url(region):
    # في الوقت الحالي، جميع المناطق تستخدم نفس نقطة النهاية
    return "https://clientbp.common.ggbluefox.com/GetLoginData"
...
# هذا السطر هو التعديل الرئيسي لـ Vercel
